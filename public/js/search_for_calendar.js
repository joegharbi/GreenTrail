...
function beforeSubmit() {
    ...
    document.getElementById("from_lat").value = `${fromLoc.lat}`;
    document.getElementById("from_lng").value = `${fromLoc.lng}`;
    document.getElementById("to_lat").value = `${toLoc.lat}`;
    document.getElementById("to_lng").value = `${toLoc.lng}`;
...
function sendRequest(apiType, params, responseHandler) {
    ...
    fetch(`${getAPI_URL()}/${apiType}?${params}`)
